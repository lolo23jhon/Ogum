...
Destructible::Destructible(const float t_max_hp,
...
float Destructible::takeDamage(Actor *t_owner, const DamageType t_dmg_type, float t_damage)
{
...
MonsterDestructible::MonsterDestructible(const float t_maxHp, const float t_defense, const char *t_corpse_name, const int t_xp)
    : Destructible(t_maxHp, t_defense, t_corpse_name, t_xp) {}
...
PlayerDestructible::PlayerDestructible(const float t_maxHp, const float t_defense, const char *t_corpse_name, const int t_xp)
    : Destructible(t_maxHp, t_defense, t_corpse_name, t_xp)
{
}
void PlayerDestructible::die(Actor *t_owner)
{
    Engine::s_engine->m_gui->message(TCODColor::red, "You died!");
    Destructible::die(t_owner);
